...
namespace litehtml
{
	...
	public:
		...
		static media_query::ptr create_from_string(tstring_view str, const std::shared_ptr<document>& doc);
		bool check(const media_features& features) const;
	};
	...
	public:
		...
		static media_query_list::ptr create_from_string(tstring_view str, const std::shared_ptr<document>& doc);
		bool is_used() const;
